            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-muted-foreground">
                  <p>
                    Founded in 2014 by experienced driving instructor John
                    Mitchell, ACT Capital Driving School began with a simple
                    mission: to provide the highest quality driving education in
                    Canberra.
                  </p>
                  <p>
                    What started as a one-person operation has grown into
                    Canberra's most trusted driving school, with a team of
                    certified instructors and a fleet of modern, safe vehicles.
                  </p>
                  <p>
                    We believe that learning to drive should be an empowering
                    experience, not a stressful one. That's why we focus on
                    building confidence alongside skills, ensuring our students
                    become not just licensed drivers, but safe and responsible
                    ones.
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              ...
              <Card className="text-center border-0 shadow-sm">
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    We adapt our teaching to each student's unique learning
                    style.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-0 shadow-sm">
                <CardContent className="p-6 space-y-4">
                  ...
                  <p className="text-muted-foreground text-sm">
                    We strive for excellence in instruction and customer
                    service.
                  </p>
                </CardContent>
              </Card>
