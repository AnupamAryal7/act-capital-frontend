...
export function WhatsAppChatBubble() {
  ...
  const phoneNumber = "+61042099533"; // Formatted for WhatsApp (removed spaces)
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <button
        ...
        className="relative group bg-green-500 hover:bg-green-600 text-white rounded-full p-4 shadow-lg transition-all duration-300 hover:scale-110 animate-pulse"
      ...
      <p className="absolut">+61042099533</p>
    </div>
  );
}
