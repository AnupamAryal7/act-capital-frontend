        ...
        <div className="md:hidden">
          ...
          <div className="relative">
            ...
            <button
              ...
              className={`relative group bg-white rounded-full p-2  shadow-[0_8px_16px_rgba(0,0,0,0.65)]
        ...
        <div className="hidden md:block">
          ...
          <div className="relative">
            ...
            <button
              ...
              onMouseEnter={() => setShowTooltip(true)}
              onMouseLeave={() => setShowTooltip(false)}
              className={`relative group bg-white hover:bg-blue-600 text-white rounded-full p-4  shadow-[0_8px_16px_rgba(0,0,0,0.65)]
            transition-all duration-300 ${
              isDragging ? "cursor-grabbing" : "cursor-pointer hover:scale-110"
            } ${
                isInDismissZone(position.x, position.y) && isDragging
